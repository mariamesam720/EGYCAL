    ...
    return Stack(
      children: [
        ...
        Positioned.fill(child: CustomPageview(controller:_controller)),
          ...
          child: Center(child: CustomIndicator(controller: _controller, count: 3))),
        Positioned(
          bottom: SizeConfig.defaultSize! * 5,
          left: 32,
          child: TextButton(onPressed: () =>Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const Welcome())),
          child: Text('Skip',
            style: TextStyle(
              fontFamily: 'lnter',
              fontSize: 16,
        ...
        NextCustomButton(pageController: _controller,),
